...
public class Screenshot extends SeleniumUtility {
	...
	public void testScreenShot() {
		...
		try {
			...
			FileUtils.copyFile(file, new File(".\\src\\test\\resources\\ScreenShots\\GoogleSearchPage4.jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		cleanUp();
	...
	public void testScreenShot2() {
		...
		takeScreenShotOfThePage(".\\src\\test\\resources\\ScreenShots\\GoogleSearchPage5.jpg");
		cleanUp();
	}
}
